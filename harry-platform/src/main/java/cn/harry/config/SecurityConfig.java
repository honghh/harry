...
import cn.harry.component.JwtAuthenticationTokenFilter;
import cn.harry.component.RestAuthenticationEntryPoint;
import cn.harry.sys.entity.SysMenu;
import cn.harry.component.RestfulAccessDeniedHandler;
...
//                .permitAll()
    ...
    public UserDetailsService userDetailsService() {
        ...
        return username -> {
            ...
            if (admin != null) {
                List<SysMenu> permissionList = sysMenuService.getPermissionList(admin.getId());
                return new SysUserDetails(admin, permissionList);
            }
