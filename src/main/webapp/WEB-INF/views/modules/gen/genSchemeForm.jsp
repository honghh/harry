...
<br/>
	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="200"  class="form-control  max-width-250 required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="category" class="form-control  max-width-250 required input-xlarge">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="packageName" htmlEscape="false" maxlength="500" class="form-control  max-width-250 required input-xlarge"/>
				<span class="help-inline">建议模块包：com.qd.modules</span>
			</div>
		</div>
		<div class="control-group">
			<label class="col-sm-3 control-label">生成模块名:</label>
			<div class="controls">
				<form:input path="moduleName" htmlEscape="false" maxlength="500" class="form-control  max-width-250 required input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="subModuleName" htmlEscape="false" maxlength="500" class="form-control  max-width-250 input-xlarge"/>
				<span class="help-inline">可选，分层下的文件夹，例如 </span>
			</div>
		</div>
		<div class="control-group">
			<label class="col-sm-3 control-label">生成功能描述:</label>
			<div class="controls">
				<form:input path="functionName" htmlEscape="false" maxlength="500" class="form-control  max-width-250 required input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="functionNameSimple" htmlEscape="false" maxlength="500" class="form-control  max-width-250 required input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="functionAuthor" htmlEscape="false" maxlength="500" class="form-control  max-width-250 required input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="genTable.id" class="form-control  max-width-250 required input-xlarge">
		...
		<div class="control-group">
			<label class="col-sm-3 control-label">生成选项:</label>
			<div class="controls">
