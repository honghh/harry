<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.micro-feeling.com/"/>
...
<!-- jeeplus -->
<link href="${ctxStatic}/common/jeeqd.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/jeeqd.js" type="text/javascript"></script>
