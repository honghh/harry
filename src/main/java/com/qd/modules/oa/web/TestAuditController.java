...
import com.qd.modules.oa.service.TestAuditService;
...
public class TestAuditController extends BaseController {
	...
	public String list(TestAudit testAudit, HttpServletRequest request,
		...
		Page<TestAudit> page = testAuditService.findPage(new Page<TestAudit>(
				request, response), testAudit);
	...
	public String save(TestAudit testAudit, Model model,
		...
		addMessage(redirectAttributes, "提交审批'" + testAudit.getUser().getName()
				+ "'成功");
