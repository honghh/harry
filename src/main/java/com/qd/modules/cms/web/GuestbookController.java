...
public class GuestbookController extends BaseController {
	...
	public String list(Guestbook guestbook, HttpServletRequest request,
		...
		Page<Guestbook> page = guestbookService.findPage(new Page<Guestbook>(
				request, response), guestbook);
	...
	public String save(Guestbook guestbook, Model model,
		...
		addMessage(
				redirectAttributes,
				DictUtils.getDictLabel(guestbook.getDelFlag(), "cms_del_flag",
						"保存") + "留言'" + guestbook.getName() + "'成功");
