...
import com.qd.modules.cms.dao.SiteDao;
...
public class SiteService extends CrudService<SiteDao, Site> {
	...
	public Page<Site> findPage(Page<Site> page, Site site) {
		...
		site.getSqlMap().put("site",
				dataScopeFilter(site.getCurrentUser(), "o", "u"));
	...
	public void save(Site site) {
		if (site.getCopyright() != null) {
			site.setCopyright(StringEscapeUtils.unescapeHtml4(site
					.getCopyright()));
		}
		super.save(site);
	...
	public void delete(Site site, Boolean isRe) {
		...
		site.setDelFlag(isRe != null && isRe ? Site.DEL_FLAG_NORMAL
				: Site.DEL_FLAG_DELETE);
		super.delete(site);
		// siteDao.delete(id);
		CmsUtils.removeCache("site_" + site.getId());
		CmsUtils.removeCache("siteList");
