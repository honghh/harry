...
import com.qd.modules.cms.dao.GuestbookDao;
...
public class GuestbookService extends CrudService<GuestbookDao, Guestbook> {
	...
	public Page<Guestbook> findPage(Page<Guestbook> page, Guestbook guestbook) {
		...
		guestbook.getSqlMap().put("dsf",
				dataScopeFilter(guestbook.getCurrentUser(), "o", "u"));
	 ...
	 */
	// FIXME 暂不提供
	public Page<Guestbook> search(Page<Guestbook> page, String q,
