...
import com.qd.modules.gen.service.GenTemplateService;
...
public class GenTemplateController extends BaseController {
	...
	public String list(GenTemplate genTemplate, HttpServletRequest request,
		...
		Page<GenTemplate> page = genTemplateService.find(new Page<GenTemplate>(
				request, response), genTemplate);
	...
	public String save(GenTemplate genTemplate, Model model,
		...
		addMessage(redirectAttributes, "保存代码模板'" + genTemplate.getName()
				+ "'成功");
